...
#ifdef HITLS_BSL_PEM
int32_t CRYPT_EAL_ParsePemPriKey(int32_t type, BSL_Buffer *encode,
...
int32_t CRYPT_EAL_ParseUnknownPriKey(int32_t type, BSL_Buffer *encode,
    const BSL_Buffer *pwd, CRYPT_EAL_PkeyCtx **ealPriKey)
{
#ifdef HITLS_BSL_PEM
...
int32_t CRYPT_EAL_PriKeyParseBuff(BSL_ParseFormat format,
...
int32_t CRYPT_EAL_ParseAsn1PubKey(int32_t type, BSL_Buffer *encode,
...
#ifdef HITLS_BSL_PEM
int32_t CRYPT_EAL_ParsePemPubKey(int32_t type, BSL_Buffer *encode,
    CRYPT_EAL_PkeyCtx **ealPubKey)
{
    BSL_PEM_Symbol symbol = {0};
...
#endif // HITLS_BSL_PEM
int32_t CRYPT_EAL_ParseUnknownPubKey(int32_t type, BSL_Buffer *encode,
    CRYPT_EAL_PkeyCtx **ealPubKey)
{
#ifdef HITLS_BSL_PEM
    bool isPem = BSL_PEM_IsPemFormat((char *)(encode->data), encode->dataLen);
...
int32_t CRYPT_EAL_PubKeyParseBuff(BSL_ParseFormat format, int32_t type,
...
int32_t CRYPT_EAL_UnKnownKeyParseBuff(BSL_ParseFormat format,
...
int32_t CRYPT_EAL_PubKeyParseFile(BSL_ParseFormat format, int32_t type,
...
int32_t CRYPT_EAL_UnKnownKeyParseFile(BSL_ParseFormat format,
...
int32_t CRYPT_EAL_EncodeAsn1PriKey(CRYPT_EAL_PkeyCtx *ealPriKey,
...
#ifdef HITLS_BSL_PEM
int32_t CRYPT_EAL_EncodePemPriKey(CRYPT_EAL_PkeyCtx *ealPriKey,
    const CRYPT_EncodeParam *encodeParam, int32_t type, BSL_Buffer *encode)
{
    BSL_Buffer asn1 = {0};
...
int32_t CRYPT_EAL_PriKeyEncodeBuff(CRYPT_EAL_PkeyCtx *ealPriKey,
...
#ifdef HITLS_BSL_SAL_FILE
int32_t CRYPT_EAL_PriKeyEncodeFile(CRYPT_EAL_PkeyCtx *ealPriKey,
