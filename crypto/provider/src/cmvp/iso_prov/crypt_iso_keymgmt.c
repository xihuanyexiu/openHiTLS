...
static int32_t PkeyCtrlCheck(CRYPT_Iso_Pkey_Ctx *ctx, int32_t opt, void *val, uint32_t len)
{
    ...
    if (opt == CRYPT_CTRL_SET_RSA_RSAES_OAEP) {
...
#define PKEY_SET_PARA_FUNC(name)                                                                             \
    ...
    {                                                                                                        \
        ...
        return CRYPT_##name##_SetPara(ctx->ctx, param);                                                      \
    }
...
#define PKEY_GET_PARA_FUNC(name)                                                                             \
    ...
    {                                                                                                        \
        ...
        return CRYPT_##name##_GetPara(ctx->ctx, param);                                                      \
    }
...
#define PKEY_GEN_KEY_FUNC(name)                                                                              \
    ...
    {                                                                                                        \
        ...
        int32_t ret = CRYPT_Iso_Log(ctx->mgrCtx, CRYPT_EVENT_GEN, CRYPT_ALGO_PKEY, ctx->algId);              \
        if (ret != CRYPT_SUCCESS) {                                                                          \
            return ret;                                                                                      \
        }                                                                                                    \
        return (name)(ctx->ctx);                                                                             \
...
#define PKEY_SET_KEY_FUNC(setPrvFunc, setPubFunc)                                                            \
    ...
    {                                                                                                        \
        ...
        ret = CRYPT_Iso_Log(ctx->mgrCtx, CRYPT_EVENT_SETSSP, CRYPT_ALGO_PKEY, ctx->algId);                   \
        if (ret != CRYPT_SUCCESS) {                                                                          \
            return ret;                                                                                      \
        }                                                                                                    \
...
#define PKEY_GET_KEY_FUNC(getPrvFunc, getPubFunc)                                                            \
    ...
    {                                                                                                        \
        ...
        int32_t ret = CRYPT_Iso_Log(ctx->mgrCtx, CRYPT_EVENT_GETSSP, CRYPT_ALGO_PKEY, ctx->algId);           \
        if (ret != CRYPT_SUCCESS) {                                                                          \
            return ret;                                                                                      \
        }                                                                                                    \
...
#define PKEY_FREE_CTX_FUNC(name)                                                                             \
    ...
    {                                                                                                        \
        ...
        (void)CRYPT_Iso_Log(ctx->mgrCtx, CRYPT_EVENT_ZERO, CRYPT_ALGO_PKEY, ctx->algId);                     \
...
#define PKEY_IMPORT_EXPORT_FUNC(name)                                                                        \
    ...
    {                                                                                                        \
        ...
        int32_t ret = CRYPT_Iso_Log(ctx->mgrCtx, CRYPT_EVENT_SETSSP, CRYPT_ALGO_PKEY, ctx->algId);           \
        if (ret != CRYPT_SUCCESS) {                                                                          \
            return ret;                                                                                      \
        }                                                                                                    \
...
PKEY_SET_KEY_FUNC(CRYPT_DSA_SetPrvKey, CRYPT_DSA_SetPubKey)
PKEY_SET_KEY_FUNC(CRYPT_CURVE25519_SetPrvKey, CRYPT_CURVE25519_SetPubKey)
PKEY_SET_KEY_FUNC(CRYPT_RSA_SetPrvKey, CRYPT_RSA_SetPubKey)
PKEY_SET_KEY_FUNC(CRYPT_DH_SetPrvKey, CRYPT_DH_SetPubKey)
PKEY_SET_KEY_FUNC(CRYPT_ECDSA_SetPrvKey, CRYPT_ECDSA_SetPubKey)
PKEY_SET_KEY_FUNC(CRYPT_ECDH_SetPrvKey, CRYPT_ECDH_SetPubKey)
PKEY_SET_KEY_FUNC(CRYPT_SM2_SetPrvKey, CRYPT_SM2_SetPubKey)
PKEY_SET_KEY_FUNC(CRYPT_ML_KEM_SetDecapsKey, CRYPT_ML_KEM_SetEncapsKey)
PKEY_SET_KEY_FUNC(CRYPT_ML_DSA_SetPrvKey, CRYPT_ML_DSA_SetPubKey)
PKEY_SET_KEY_FUNC(CRYPT_SLH_DSA_SetPrvKey, CRYPT_SLH_DSA_SetPubKey)

PKEY_GET_KEY_FUNC(CRYPT_DSA_GetPrvKey, CRYPT_DSA_GetPubKey)
PKEY_GET_KEY_FUNC(CRYPT_CURVE25519_GetPrvKey, CRYPT_CURVE25519_GetPubKey)
PKEY_GET_KEY_FUNC(CRYPT_RSA_GetPrvKey, CRYPT_RSA_GetPubKey)
PKEY_GET_KEY_FUNC(CRYPT_DH_GetPrvKey, CRYPT_DH_GetPubKey)
PKEY_GET_KEY_FUNC(CRYPT_ECDSA_GetPrvKey, CRYPT_ECDSA_GetPubKey)
PKEY_GET_KEY_FUNC(CRYPT_ECDH_GetPrvKey, CRYPT_ECDH_GetPubKey)
PKEY_GET_KEY_FUNC(CRYPT_SM2_GetPrvKey, CRYPT_SM2_GetPubKey)
PKEY_GET_KEY_FUNC(CRYPT_ML_KEM_GetDecapsKey, CRYPT_ML_KEM_GetEncapsKey)
PKEY_GET_KEY_FUNC(CRYPT_ML_DSA_GetPrvKey, CRYPT_ML_DSA_GetPubKey)
PKEY_GET_KEY_FUNC(CRYPT_SLH_DSA_GetPrvKey, CRYPT_SLH_DSA_GetPubKey)
...
const CRYPT_EAL_Func g_isoKeyMgmtDsa[] = {
    ...
    {CRYPT_EAL_IMPLPKEYMGMT_SETPRV, (CRYPT_EAL_ImplPkeyMgmtSetPrv)CRYPT_DSA_SetPrvKeyWrapper},
    {CRYPT_EAL_IMPLPKEYMGMT_SETPUB, (CRYPT_EAL_ImplPkeyMgmtSetPub)CRYPT_DSA_SetPubKeyWrapper},
    {CRYPT_EAL_IMPLPKEYMGMT_GETPRV, (CRYPT_EAL_ImplPkeyMgmtGetPrv)CRYPT_DSA_GetPrvKeyWrapper},
    {CRYPT_EAL_IMPLPKEYMGMT_GETPUB, (CRYPT_EAL_ImplPkeyMgmtGetPub)CRYPT_DSA_GetPubKeyWrapper},
...
const CRYPT_EAL_Func g_isoKeyMgmtEd25519[] = {
    ...
    {CRYPT_EAL_IMPLPKEYMGMT_SETPRV, (CRYPT_EAL_ImplPkeyMgmtSetPrv)CRYPT_CURVE25519_SetPrvKeyWrapper},
    {CRYPT_EAL_IMPLPKEYMGMT_SETPUB, (CRYPT_EAL_ImplPkeyMgmtSetPub)CRYPT_CURVE25519_SetPubKeyWrapper},
    {CRYPT_EAL_IMPLPKEYMGMT_GETPRV, (CRYPT_EAL_ImplPkeyMgmtGetPrv)CRYPT_CURVE25519_GetPrvKeyWrapper},
    {CRYPT_EAL_IMPLPKEYMGMT_GETPUB, (CRYPT_EAL_ImplPkeyMgmtGetPub)CRYPT_CURVE25519_GetPubKeyWrapper},
...
const CRYPT_EAL_Func g_isoKeyMgmtRsa[] = {
    ...
    {CRYPT_EAL_IMPLPKEYMGMT_SETPRV, (CRYPT_EAL_ImplPkeyMgmtSetPrv)CRYPT_RSA_SetPrvKeyWrapper},
    {CRYPT_EAL_IMPLPKEYMGMT_SETPUB, (CRYPT_EAL_ImplPkeyMgmtSetPub)CRYPT_RSA_SetPubKeyWrapper},
    {CRYPT_EAL_IMPLPKEYMGMT_GETPRV, (CRYPT_EAL_ImplPkeyMgmtGetPrv)CRYPT_RSA_GetPrvKeyWrapper},
    {CRYPT_EAL_IMPLPKEYMGMT_GETPUB, (CRYPT_EAL_ImplPkeyMgmtGetPub)CRYPT_RSA_GetPubKeyWrapper},
...
const CRYPT_EAL_Func g_isoKeyMgmtDh[] = {
    ...
    {CRYPT_EAL_IMPLPKEYMGMT_SETPRV, (CRYPT_EAL_ImplPkeyMgmtSetPrv)CRYPT_DH_SetPrvKeyWrapper},
    {CRYPT_EAL_IMPLPKEYMGMT_SETPUB, (CRYPT_EAL_ImplPkeyMgmtSetPub)CRYPT_DH_SetPubKeyWrapper},
...
const CRYPT_EAL_Func g_isoKeyMgmtEcdsa[] = {
    ...
    {CRYPT_EAL_IMPLPKEYMGMT_SETPRV, (CRYPT_EAL_ImplPkeyMgmtSetPrv)CRYPT_ECDSA_SetPrvKeyWrapper},
    {CRYPT_EAL_IMPLPKEYMGMT_SETPUB, (CRYPT_EAL_ImplPkeyMgmtSetPub)CRYPT_ECDSA_SetPubKeyWrapper},
    {CRYPT_EAL_IMPLPKEYMGMT_GETPRV, (CRYPT_EAL_ImplPkeyMgmtGetPrv)CRYPT_ECDSA_GetPrvKeyWrapper},
    {CRYPT_EAL_IMPLPKEYMGMT_GETPUB, (CRYPT_EAL_ImplPkeyMgmtGetPub)CRYPT_ECDSA_GetPubKeyWrapper},
...
const CRYPT_EAL_Func g_isoKeyMgmtEcdh[] = {
    ...
    {CRYPT_EAL_IMPLPKEYMGMT_SETPRV, (CRYPT_EAL_ImplPkeyMgmtSetPrv)CRYPT_ECDH_SetPrvKeyWrapper},
    {CRYPT_EAL_IMPLPKEYMGMT_SETPUB, (CRYPT_EAL_ImplPkeyMgmtSetPub)CRYPT_ECDH_SetPubKeyWrapper},
    {CRYPT_EAL_IMPLPKEYMGMT_GETPRV, (CRYPT_EAL_ImplPkeyMgmtGetPrv)CRYPT_ECDH_GetPrvKeyWrapper},
    {CRYPT_EAL_IMPLPKEYMGMT_GETPUB, (CRYPT_EAL_ImplPkeyMgmtGetPub)CRYPT_ECDH_GetPubKeyWrapper},
...
const CRYPT_EAL_Func g_isoKeyMgmtSm2[] = {
    ...
    {CRYPT_EAL_IMPLPKEYMGMT_SETPRV, (CRYPT_EAL_ImplPkeyMgmtSetPrv)CRYPT_SM2_SetPrvKeyWrapper},
    {CRYPT_EAL_IMPLPKEYMGMT_SETPUB, (CRYPT_EAL_ImplPkeyMgmtSetPub)CRYPT_SM2_SetPubKeyWrapper},
    {CRYPT_EAL_IMPLPKEYMGMT_GETPRV, (CRYPT_EAL_ImplPkeyMgmtGetPrv)CRYPT_SM2_GetPrvKeyWrapper},
    {CRYPT_EAL_IMPLPKEYMGMT_GETPUB, (CRYPT_EAL_ImplPkeyMgmtGetPub)CRYPT_SM2_GetPubKeyWrapper},
...
const CRYPT_EAL_Func g_isoKeyMgmtMlKem[] = {
    ...
    {CRYPT_EAL_IMPLPKEYMGMT_SETPRV, (CRYPT_EAL_ImplPkeyMgmtSetPrv)CRYPT_ML_KEM_SetDecapsKeyWrapper},
    {CRYPT_EAL_IMPLPKEYMGMT_SETPUB, (CRYPT_EAL_ImplPkeyMgmtSetPub)CRYPT_ML_KEM_SetEncapsKeyWrapper},
    {CRYPT_EAL_IMPLPKEYMGMT_GETPRV, (CRYPT_EAL_ImplPkeyMgmtGetPrv)CRYPT_ML_KEM_GetDecapsKeyWrapper},
    {CRYPT_EAL_IMPLPKEYMGMT_GETPUB, (CRYPT_EAL_ImplPkeyMgmtGetPub)CRYPT_ML_KEM_GetEncapsKeyWrapper},
...
const CRYPT_EAL_Func g_isoKeyMgmtMlDsa[] = {
    ...
    {CRYPT_EAL_IMPLPKEYMGMT_SETPRV, (CRYPT_EAL_ImplPkeyMgmtSetPrv)CRYPT_ML_DSA_SetPrvKeyWrapper},
    {CRYPT_EAL_IMPLPKEYMGMT_SETPUB, (CRYPT_EAL_ImplPkeyMgmtSetPub)CRYPT_ML_DSA_SetPubKeyWrapper},
    {CRYPT_EAL_IMPLPKEYMGMT_GETPRV, (CRYPT_EAL_ImplPkeyMgmtGetPrv)CRYPT_ML_DSA_GetPrvKeyWrapper},
    {CRYPT_EAL_IMPLPKEYMGMT_GETPUB, (CRYPT_EAL_ImplPkeyMgmtGetPub)CRYPT_ML_DSA_GetPubKeyWrapper},
...
const CRYPT_EAL_Func g_isoKeyMgmtSlhDsa[] = {
    ...
    {CRYPT_EAL_IMPLPKEYMGMT_SETPRV, (CRYPT_EAL_ImplPkeyMgmtSetPrv)CRYPT_SLH_DSA_SetPrvKeyWrapper},
    {CRYPT_EAL_IMPLPKEYMGMT_SETPUB, (CRYPT_EAL_ImplPkeyMgmtSetPub)CRYPT_SLH_DSA_SetPubKeyWrapper},
    {CRYPT_EAL_IMPLPKEYMGMT_GETPRV, (CRYPT_EAL_ImplPkeyMgmtGetPrv)CRYPT_SLH_DSA_GetPrvKeyWrapper},
    {CRYPT_EAL_IMPLPKEYMGMT_GETPUB, (CRYPT_EAL_ImplPkeyMgmtGetPub)CRYPT_SLH_DSA_GetPubKeyWrapper},
