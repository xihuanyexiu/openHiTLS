...
typedef int32_t (*CRYPT_EAL_ImplPkeyEncapsInit)(const void *ctx, const BSL_Param *params);
typedef int32_t (*CRYPT_EAL_ImplPkeyDecapsInit)(const void *ctx, const BSL_Param *params);
