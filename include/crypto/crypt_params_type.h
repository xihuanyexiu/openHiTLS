...
#define CRYPT_PARAM_RSA_N            (CRYPT_PARAM_KDF_BASE + 1)
#define CRYPT_PARAM_RSA_E            (CRYPT_PARAM_KDF_BASE + 2)
#define CRYPT_PARAM_RSA_D            (CRYPT_PARAM_KDF_BASE + 3)
#define CRYPT_PARAM_RSA_P            (CRYPT_PARAM_KDF_BASE + 4)
#define CRYPT_PARAM_RSA_Q            (CRYPT_PARAM_KDF_BASE + 5)
#define CRYPT_PARAM_RSA_DQ           (CRYPT_PARAM_KDF_BASE + 6)
#define CRYPT_PARAM_RSA_DP           (CRYPT_PARAM_KDF_BASE + 7)
#define CRYPT_PARAM_RSA_QINV         (CRYPT_PARAM_KDF_BASE + 8)
#define CRYPT_PARAM_RSA_BITS         (CRYPT_PARAM_KDF_BASE + 9)
