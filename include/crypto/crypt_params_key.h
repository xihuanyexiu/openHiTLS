...
#define CRYPT_PARAM_DECODE_PKEY_METHOD_FUNC              (CRYPT_PARAM_DECODE_BASE + 8)
#define CRYPT_PARAM_DECODE_LIB_CTX                       (CRYPT_PARAM_DECODE_BASE + 9)
#define CRYPT_PARAM_DECODE_TARGET_ATTR_NAME              (CRYPT_PARAM_DECODE_BASE + 10)
#define CRYPT_PARAM_DECODE_PROVIDER_CTX                  (CRYPT_PARAM_DECODE_BASE + 11)
#define CRYPT_PARAM_DECODE_FLAG_FREE_OUTDATA              (CRYPT_PARAM_DECODE_BASE + 12)
