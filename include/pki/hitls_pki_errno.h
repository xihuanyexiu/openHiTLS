...
typedef enum {
    ...
    HITLS_X509_ERR_VFY_SKI_NOT_FOUND,
    HITLS_X509_ERR_VFY_GET_NOTBEFORE_FAIL,
    HITLS_X509_ERR_VFY_NOTBEFORE_IN_FUTURE,
    HITLS_X509_ERR_VFY_GET_NOTAFTER_FAIL,
    HITLS_X509_ERR_VFY_NOTAFTER_EXPIRED,
    HITLS_X509_ERR_VFY_GET_THISUPDATE_FAIL,
    HITLS_X509_ERR_VFY_THISUPDATE_IN_FUTURE,
    HITLS_X509_ERR_VFY_GET_NEXTUPDATE_FAIL,
    HITLS_X509_ERR_VFY_NEXTUPDATE_EXPIRED,
    HITLS_X509_ERR_VFY_CRLSIGN_FAIL,
    HITLS_X509_ERR_VFY_CERT_SIGN_FAIL,
    HITLS_X509_ERR_VFY_GET_PUBKEY_SIGNID,
    HITLS_X509_ERR_VFY_CRL_NOT_FOUND,
    HITLS_X509_ERR_VFY_INVALID_PURPOSE,
    ...
    HITLS_X509_ERR_EXT_UNKNOWN_ERROR,
    ...
    HITLS_PKCS12_ERR_NO_ENCRYPT_PARAM,
    HITLS_PKCS12_ERR_NO_MAC_PARAM,
    HITLS_PKCS12_ERR_NO_SAFEBAG_ATTRIBUTES,
    HITLS_PKCS12_ERR_BAG_NO_KEY,
    HITLS_PKCS12_ERR_BAG_NO_CERT,
    HITLS_PKCS12_ERR_BAG_NO_SECRET,
    HITLS_PKCS12_ERR_BUFFLEN_NOT_ENOUGH,

    HITLS_PRINT_ERR_SIGN_ALG = 0x04080001,
    HITLS_PRINT_ERR_PUBKEY,
    HITLS_PRINT_ERR_CERT_TBS,
    HITLS_PRINT_ERR_CERT,
    HITLS_PRINT_ERR_DNNAME,
    HITLS_PRINT_ERR_DNNAME_VALUE,
    HITLS_PRINT_ERR_DNNAME_HASH,
    HITLS_PRINT_ERR_EXT_NAME,
    HITLS_PRINT_ERR_EXT,
    HITLS_PRINT_ERR_EXT_KU,
    HITLS_PRINT_ERR_EXT_EXTKU,
    HITLS_PRINT_ERR_EXT_SKI,
    HITLS_PRINT_ERR_EXT_AKI_KID,
    HITLS_PRINT_ERR_EXT_AKI_ISSUER,
    HITLS_PRINT_ERR_EXT_AKI_SERIAL,
    HITLS_PRINT_ERR_GNNAME,
    HITLS_PRINT_ERR_GNNAME_UNKNOWN,
    HITLS_PRINT_ERR_CSR_INFO,
    HITLS_PRINT_ERR_CSR,
    HITLS_PRINT_ERR_SIGN_ALG_UNSUPPORT,
    HITLS_PRINT_ERR_CRL,
