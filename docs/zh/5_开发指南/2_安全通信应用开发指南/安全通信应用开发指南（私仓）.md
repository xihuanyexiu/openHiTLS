...
| 椭圆曲线 | secp256r1（23）<br>secp384r1（24）<br>secp521r1（25）<br>brainpoolP256r1（26）<br>brainpoolP384r1（27）<br>brainpoolP512r1（28）<br>x25519（29）<br>x448（30） |
...
| EC点格式 | uncompressed（0） |
| 椭圆曲线 | secp256r1（23）<br>secp384r1（24）<br>secp521r1（25）<br>x25519（29）<br>x448（30）<br>ffdhe2048（256）<br>ffdhe3072（257）<br>ffdhe4096（258）<br>ffdhe6144（259）<br>ffdhe8192（260） |
...
![image](./0181da37-811a-42cf-938a-9956fdc484ed..png)
...
![image](./3c2794e5-fd1c-4bac-b4b3-b4f395b0b434..png)
