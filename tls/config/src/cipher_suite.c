...
static const CipherSuiteInfo g_cipherSuiteList[] = {
    {.enable = true,
     .name = "HITLS_AES_128_GCM_SHA256",
     .stdName = "TLS_AES_128_GCM_SHA256",
     ...
     .strengthBits = 128},
    {.enable = true,
     .name = "HITLS_AES_256_GCM_SHA384",
     .stdName = "TLS_AES_256_GCM_SHA384",
     ...
     .strengthBits = 256},
    {.enable = true,
     .name = "HITLS_CHACHA20_POLY1305_SHA256",
     .stdName = "TLS_CHACHA20_POLY1305_SHA256",
     ...
     .strengthBits = 256},
    {.enable = true,
     .name = "HITLS_AES_128_CCM_SHA256",
     .stdName = "TLS_AES_128_CCM_SHA256",
     ...
     .strengthBits = 128},
    {.enable = true,
     .name = "HITLS_AES_128_CCM_8_SHA256",
     .stdName = "TLS_AES_128_CCM_8_SHA256",
     ...
     .strengthBits = 128},
    {.enable = true,
     .name = "HITLS_RSA_WITH_AES_128_CBC_SHA",
     .stdName = "TLS_RSA_WITH_AES_128_CBC_SHA",
     ...
     .strengthBits = 128},
    {.enable = true,
     .name = "HITLS_RSA_WITH_AES_256_CBC_SHA",
     .stdName = "TLS_RSA_WITH_AES_256_CBC_SHA",
     ...
     .strengthBits = 256},
    {.enable = true,
     .name = "HITLS_RSA_WITH_AES_128_CBC_SHA256",
     .stdName = "TLS_RSA_WITH_AES_128_CBC_SHA256",
     ...
     .strengthBits = 128},
    {.enable = true,
     .name = "HITLS_RSA_WITH_AES_256_CBC_SHA256",
     .stdName = "TLS_RSA_WITH_AES_256_CBC_SHA256",
     ...
     .macAlg = HITLS_MAC_256,
     .hashAlg = HITLS_HASH_SHA_256,
     .signScheme = CERT_SIG_SCHEME_RSA_PKCS1_SHA256,
     KEY_BLOCK_PARTITON_LENGTH(16u, 32u, 32u, 16u, 16u, 32u),
     VERSION_SCOPE(HITLS_VERSION_TLS12, HITLS_VERSION_TLS12, HITLS_VERSION_DTLS12, HITLS_VERSION_DTLS12),
     .cipherType = HITLS_CBC_CIPHER,
     .strengthBits = 256},
    {.enable = true,
     .name = "HITLS_RSA_WITH_AES_128_GCM_SHA256",
     .stdName = "TLS_RSA_WITH_AES_128_GCM_SHA256",
     ...
     .strengthBits = 128},
    {.enable = true,
     .name = "HITLS_RSA_WITH_AES_256_GCM_SHA384",
     .stdName = "TLS_RSA_WITH_AES_256_GCM_SHA384",
     ...
     .macAlg = HITLS_MAC_AEAD,
     .hashAlg = HITLS_HASH_SHA_384,
     .signScheme = CERT_SIG_SCHEME_RSA_PKCS1_SHA384,
     KEY_BLOCK_PARTITON_LENGTH(4u, 32u, 0u, 0u, 8u, 16u),
     VERSION_SCOPE(HITLS_VERSION_TLS12, HITLS_VERSION_TLS12, HITLS_VERSION_DTLS12, HITLS_VERSION_DTLS12),
     .cipherType = HITLS_AEAD_CIPHER,
     .strengthBits = 256},
    {.enable = true,
     .name = "HITLS_DHE_RSA_WITH_AES_128_GCM_SHA256",
     .stdName = "TLS_DHE_RSA_WITH_AES_128_GCM_SHA256",
     ...
     .strengthBits = 128},
    {.enable = true,
     .name = "HITLS_DHE_RSA_WITH_AES_256_GCM_SHA384",
     .stdName = "TLS_DHE_RSA_WITH_AES_256_GCM_SHA384",
     ...
     .strengthBits = 256},
    {.enable = true,
     .name = "HITLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA",
     .stdName = "TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA",
     ...
     .strengthBits = 128},
    {.enable = true,
     .name = "HITLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA",
     .stdName = "TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA",
     ...
     .strengthBits = 256},
    {.enable = true,
     .name = "HITLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA256",
     .stdName = "TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA256",
     ...
     .macAlg = HITLS_MAC_256,
     .hashAlg = HITLS_HASH_SHA_256,
     .signScheme = CERT_SIG_SCHEME_ECDSA_SECP256R1_SHA256,
     KEY_BLOCK_PARTITON_LENGTH(16u, 16u, 32u, 16u, 16u, 32u),
     VERSION_SCOPE(HITLS_VERSION_TLS12, HITLS_VERSION_TLS12, HITLS_VERSION_DTLS12, HITLS_VERSION_DTLS12),
     .cipherType = HITLS_CBC_CIPHER,
     .strengthBits = 128},
    {.enable = true,
     .name = "HITLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA384",
     .stdName = "TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA384",
     ...
     .hashAlg = HITLS_HASH_SHA_384,
     .signScheme = CERT_SIG_SCHEME_ECDSA_SECP384R1_SHA384,
     KEY_BLOCK_PARTITON_LENGTH(16u, 32u, 48u, 16u, 16u, 48u),
     VERSION_SCOPE(HITLS_VERSION_TLS12, HITLS_VERSION_TLS12, HITLS_VERSION_DTLS12, HITLS_VERSION_DTLS12),
     .cipherType = HITLS_CBC_CIPHER,
     .strengthBits = 256},
    {.enable = true,
     .name = "HITLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256",
     .stdName = "TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256",
     ...
     .strengthBits = 128},
    {.enable = true,
     .name = "HITLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384",
     .stdName = "TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384",
     ...
     .strengthBits = 256},
    {.enable = true,
     .name = "HITLS_ECDHE_RSA_WITH_AES_128_CBC_SHA",
     .stdName = "TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA",
     ...
     .strengthBits = 128},
    {.enable = true,
     .name = "HITLS_ECDHE_RSA_WITH_AES_256_CBC_SHA",
     ...
     .strengthBits = 256},
    {.enable = true,
     .name = "HITLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256",
     .stdName = "TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256",
     ...
     .strengthBits = 128},
    {.enable = true,
     .name = "HITLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384",
     .stdName = "TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384",
     ...
     .strengthBits = 256},
    {.enable = true,
     .name = "HITLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256",
     ...
     .strengthBits = 128},
    {.enable = true,
     .name = "HITLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384",
     .stdName = "TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384",
     ...
     .strengthBits = 256},
    {.enable = true,
     .name = "HITLS_ECDHE_RSA_WITH_CHACHA20_POLY1305_SHA256",
     .stdName = "TLS_ECDHE_RSA_WITH_CHACHA20_POLY1305_SHA256",
     ...
     .strengthBits = 256},
    {.enable = true,
     .name = "HITLS_ECDHE_ECDSA_WITH_CHACHA20_POLY1305_SHA256",
     .stdName = "TLS_ECDHE_ECDSA_WITH_CHACHA20_POLY1305_SHA256",
     ...
     .strengthBits = 256},
    {.enable = true,
     .name = "HITLS_DHE_RSA_WITH_CHACHA20_POLY1305_SHA256",
     .stdName = "TLS_DHE_RSA_WITH_CHACHA20_POLY1305_SHA256",
     ...
     .strengthBits = 256},
    {.enable = true,
     .name = "HITLS_DHE_DSS_WITH_AES_128_GCM_SHA256",
     .stdName = "TLS_DHE_DSS_WITH_AES_128_GCM_SHA256",
     ...
     .macAlg = HITLS_MAC_AEAD,
     .hashAlg = HITLS_HASH_SHA_256,
     .signScheme = CERT_SIG_SCHEME_DSA_SHA256,
     KEY_BLOCK_PARTITON_LENGTH(4u, 16u, 0u, 0u, 8u, 16u),
     VERSION_SCOPE(HITLS_VERSION_TLS12, HITLS_VERSION_TLS12, HITLS_VERSION_DTLS12, HITLS_VERSION_DTLS12),
     .cipherType = HITLS_AEAD_CIPHER,
     .strengthBits = 128},
    {.enable = true,
     .name = "HITLS_DHE_DSS_WITH_AES_256_GCM_SHA384",
     .stdName = "TLS_DHE_DSS_WITH_AES_256_GCM_SHA384",
     ...
     .macAlg = HITLS_MAC_AEAD,
     .hashAlg = HITLS_HASH_SHA_384,
     .signScheme = CERT_SIG_SCHEME_DSA_SHA384,
     KEY_BLOCK_PARTITON_LENGTH(4u, 32u, 0u, 0u, 8u, 16u),
     VERSION_SCOPE(HITLS_VERSION_TLS12, HITLS_VERSION_TLS12, HITLS_VERSION_DTLS12, HITLS_VERSION_DTLS12),
     .cipherType = HITLS_AEAD_CIPHER,
     .strengthBits = 256},
    {.enable = true,
     .name = "HITLS_DHE_DSS_WITH_AES_128_CBC_SHA",
     ...
     .strengthBits = 128},
    {.enable = true,
     .name = "HITLS_DHE_DSS_WITH_AES_256_CBC_SHA",
     .stdName = "TLS_DHE_DSS_WITH_AES_256_CBC_SHA",
     ...
     .strengthBits = 256},
    {.enable = true,
     .name = "HITLS_DHE_DSS_WITH_AES_128_CBC_SHA256",
     .stdName = "TLS_DHE_DSS_WITH_AES_128_CBC_SHA256",
     ...
     .strengthBits = 128},
    {.enable = true,
     .name = "HITLS_DHE_DSS_WITH_AES_256_CBC_SHA256",
     .stdName = "TLS_DHE_DSS_WITH_AES_256_CBC_SHA256",
     ...
     .strengthBits = 256},
    {.enable = true,
     .name = "HITLS_DHE_RSA_WITH_AES_128_CBC_SHA",
     .stdName = "TLS_DHE_RSA_WITH_AES_128_CBC_SHA",
     ...
     .strengthBits = 128},
    {.enable = true,
     .name = "HITLS_DHE_RSA_WITH_AES_256_CBC_SHA",
     .stdName = "TLS_DHE_RSA_WITH_AES_256_CBC_SHA",
     ...
     .strengthBits = 256},
    {.enable = true,
     .name = "HITLS_DHE_RSA_WITH_AES_128_CBC_SHA256",
     .stdName = "TLS_DHE_RSA_WITH_AES_128_CBC_SHA256",
     ...
     .strengthBits = 128},
    {.enable = true,
     .name = "HITLS_DHE_RSA_WITH_AES_256_CBC_SHA256",
     .stdName = "TLS_DHE_RSA_WITH_AES_256_CBC_SHA256",
    ...
    // psk nego
    {.enable = true,
     .name = "HITLS_PSK_WITH_AES_128_CBC_SHA",
     .stdName = "TLS_PSK_WITH_AES_128_CBC_SHA",
     ...
     .strengthBits = 128},
    {.enable = true,
     .name = "HITLS_PSK_WITH_AES_256_CBC_SHA",
     .stdName = "TLS_PSK_WITH_AES_256_CBC_SHA",
     ...
     .strengthBits = 256},
    {.enable = true,
     .name = "HITLS_DHE_PSK_WITH_AES_128_CBC_SHA",
     .stdName = "TLS_DHE_PSK_WITH_AES_128_CBC_SHA",
     ...
     .strengthBits = 128},
    {.enable = true,
     .name = "HITLS_DHE_PSK_WITH_AES_256_CBC_SHA",
     .stdName = "TLS_DHE_PSK_WITH_AES_256_CBC_SHA",
     ...
     .strengthBits = 256},
    {.enable = true,
     .name = "HITLS_RSA_PSK_WITH_AES_128_CBC_SHA",
     .stdName = "TLS_RSA_PSK_WITH_AES_128_CBC_SHA",
     ...
     .strengthBits = 128},
    {.enable = true,
     .name = "HITLS_RSA_PSK_WITH_AES_256_CBC_SHA",
     .stdName = "TLS_RSA_PSK_WITH_AES_256_CBC_SHA",
     ...
     .strengthBits = 256},
    {.enable = true,
     .name = "HITLS_PSK_WITH_AES_128_GCM_SHA256",
     .stdName = "TLS_PSK_WITH_AES_128_GCM_SHA256",
     ...
     .strengthBits = 128},
    {.enable = true,
     .name = "HITLS_PSK_WITH_AES_256_GCM_SHA384",
     .stdName = "TLS_PSK_WITH_AES_256_GCM_SHA384",
     ...
     .strengthBits = 256},
     {.enable = true,
     .name = "HITLS_PSK_WITH_AES_256_CCM",
     .stdName = "TLS_PSK_WITH_AES_256_CCM",
     ...
     .strengthBits = 256},
    {.enable = true,
     .name = "HITLS_DHE_PSK_WITH_AES_128_GCM_SHA256",
     .stdName = "TLS_DHE_PSK_WITH_AES_128_GCM_SHA256",
     ...
     .strengthBits = 128},
    {.enable = true,
     .name = "HITLS_DHE_PSK_WITH_AES_256_GCM_SHA384",
     .stdName = "TLS_DHE_PSK_WITH_AES_256_GCM_SHA384",
     ...
     .strengthBits = 256},
    {.enable = true,
     .name = "HITLS_DHE_PSK_WITH_AES_128_CCM",
     .stdName = "TLS_DHE_PSK_WITH_AES_128_CCM",
     ...
     .strengthBits = 128},
    {.enable = true,
     .name = "HITLS_DHE_PSK_WITH_AES_256_CCM",
     .stdName = "TLS_DHE_PSK_WITH_AES_256_CCM",
     ...
     .strengthBits = 256},
    {.enable = true,
     .name = "HITLS_RSA_PSK_WITH_AES_128_GCM_SHA256",
     .stdName = "TLS_RSA_PSK_WITH_AES_128_GCM_SHA256",
     ...
     .strengthBits = 128},
    {.enable = true,
     .name = "HITLS_RSA_PSK_WITH_AES_256_GCM_SHA384",
     .stdName = "TLS_RSA_PSK_WITH_AES_256_GCM_SHA384",
     ...
     .strengthBits = 256},
    {.enable = true,
     .name = "HITLS_PSK_WITH_AES_128_CBC_SHA256",
     .stdName = "TLS_PSK_WITH_AES_128_CBC_SHA256",
     ...
     .strengthBits = 128},
    {.enable = true,
     .name = "HITLS_PSK_WITH_AES_256_CBC_SHA384",
     .stdName = "TLS_PSK_WITH_AES_256_CBC_SHA384",
     ...
     .strengthBits = 256},
    {.enable = true,
     .name = "HITLS_DHE_PSK_WITH_AES_128_CBC_SHA256",
     .stdName = "TLS_DHE_PSK_WITH_AES_128_CBC_SHA256",
     ...
     .strengthBits = 128},
    {.enable = true,
     .name = "HITLS_DHE_PSK_WITH_AES_256_CBC_SHA384",
     .stdName = "TLS_DHE_PSK_WITH_AES_256_CBC_SHA384",
     ...
     .strengthBits = 256},
    {.enable = true,
     .name = "HITLS_RSA_PSK_WITH_AES_128_CBC_SHA256",
     .stdName = "TLS_RSA_PSK_WITH_AES_128_CBC_SHA256",
     ...
     .strengthBits = 128},
    {.enable = true,
     .name = "HITLS_RSA_PSK_WITH_AES_256_CBC_SHA384",
     .stdName = "TLS_RSA_PSK_WITH_AES_256_CBC_SHA384",
     ...
     .strengthBits = 256},
    {.enable = true,
     .name = "HITLS_ECDHE_PSK_WITH_AES_128_CBC_SHA",
     .stdName = "TLS_ECDHE_PSK_WITH_AES_128_CBC_SHA",
     ...
     .strengthBits = 128},
    {.enable = true,
     .name = "HITLS_ECDHE_PSK_WITH_AES_256_CBC_SHA",
     .stdName = "TLS_ECDHE_PSK_WITH_AES_256_CBC_SHA",
     ...
     .strengthBits = 256},
    {.enable = true,
     .name = "HITLS_ECDHE_PSK_WITH_AES_128_CBC_SHA256",
     .stdName = "TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA",
     ...
     .strengthBits = 128},
    {.enable = true,
     .name = "HITLS_ECDHE_PSK_WITH_AES_256_CBC_SHA384",
     .stdName = "TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA",
     ...
     .strengthBits = 256},
    {.enable = true,
     .name = "HITLS_PSK_WITH_CHACHA20_POLY1305_SHA256",
     .stdName = "TLS_PSK_WITH_CHACHA20_POLY1305_SHA256",
     ...
     .strengthBits = 256},
    {.enable = true,
     .name = "HITLS_ECDHE_PSK_WITH_CHACHA20_POLY1305_SHA256",
     .stdName = "TLS_ECDHE_PSK_WITH_CHACHA20_POLY1305_SHA256",
     ...
     .strengthBits = 256},
    {.enable = true,
     .name = "HITLS_DHE_PSK_WITH_CHACHA20_POLY1305_SHA256",
     .stdName = "TLS_DHE_PSK_WITH_CHACHA20_POLY1305_SHA256",
     ...
     .strengthBits = 256},
    {.enable = true,
     .name = "HITLS_RSA_PSK_WITH_CHACHA20_POLY1305_SHA256",
     .stdName = "TLS_RSA_PSK_WITH_CHACHA20_POLY1305_SHA256",
     ...
     .strengthBits = 256},
    {.enable = true,
     .name = "HITLS_ECDHE_PSK_WITH_AES_128_CCM_SHA256",
     .stdName = "TLS_ECDHE_PSK_WITH_AES_128_CCM_SHA256",
     ...
     .strengthBits = 128},
    {.enable = true,
     .name = "HITLS_ECDHE_PSK_WITH_AES_128_GCM_SHA256",
     .stdName = "TLS_ECDHE_PSK_WITH_AES_128_GCM_SHA256",
     ...
     .strengthBits = 128},
    {.enable = true,
     .name = "HITLS_ECDHE_PSK_WITH_AES_256_GCM_SHA384",
     .stdName = "TLS_ECDHE_PSK_WITH_AES_256_GCM_SHA384",
    ...
    {.enable = true,
     .name = "HITLS_DH_ANON_WITH_AES_128_CBC_SHA",
     .stdName = "TLS_DH_ANON_WITH_AES_128_CBC_SHA",
     ...
     .strengthBits = 128},
    {.enable = true,
     .name = "HITLS_DH_ANON_WITH_AES_256_CBC_SHA",
     .stdName = "TLS_DH_ANON_WITH_AES_256_CBC_SHA",
     ...
     .strengthBits = 256},
    {.enable = true,
     .name = "HITLS_DH_ANON_WITH_AES_128_CBC_SHA256",
     .stdName = "TLS_DH_ANON_WITH_AES_128_CBC_SHA256",
     ...
     .strengthBits = 128},
    {.enable = true,
     .name = "HITLS_DH_ANON_WITH_AES_256_CBC_SHA256",
     .stdName = "TLS_DH_ANON_WITH_AES_256_CBC_SHA256",
     ...
     .strengthBits = 256},
    {.enable = true,
     .name = "HITLS_DH_ANON_WITH_AES_128_GCM_SHA256",
     .stdName = "TLS_DH_ANON_WITH_AES_128_GCM_SHA256",
     ...
     .strengthBits = 128},
    {.enable = true,
     .name = "HITLS_DH_ANON_WITH_AES_256_GCM_SHA384",
     .stdName = "TLS_DH_ANON_WITH_AES_256_GCM_SHA384",
     ...
     .strengthBits = 256},
    {.enable = true,
     .name = "HITLS_ECDH_ANON_WITH_AES_128_CBC_SHA",
     .stdName = "TLS_ECDH_ANON_WITH_AES_128_CBC_SHA",
     ...
     .strengthBits = 128},
    {.enable = true,
     .name = "HITLS_ECDH_ANON_WITH_AES_256_CBC_SHA",
     .stdName = "TLS_ECDH_ANON_WITH_AES_256_CBC_SHA",
     ...
     .strengthBits = 256},
    {.enable = true,
     .name = "HITLS_ECDHE_ECDSA_WITH_AES_128_CCM",
     ...
     .strengthBits = 128},
    {.enable = true,
     .name = "HITLS_ECDHE_ECDSA_WITH_AES_256_CCM",
     .stdName = "TLS_ECDHE_ECDSA_WITH_AES_256_CCM",
     ...
     .strengthBits = 256},
    {.enable = true,
     .name = "HITLS_DHE_RSA_WITH_AES_128_CCM",
     .stdName = "TLS_DHE_RSA_WITH_AES_128_CCM",
     ...
     .strengthBits = 128},
    {.enable = true,
     .name = "HITLS_DHE_RSA_WITH_AES_256_CCM",
     .stdName = "TLS_DHE_RSA_WITH_AES_256_CCM",
     ...
     .strengthBits = 256},
    {.enable = true,
     .name = "HITLS_RSA_WITH_AES_128_CCM",
     .stdName = "TLS_RSA_WITH_AES_128_CCM",
     ...
     .strengthBits = 128},
    {.enable = true,
     .name = "HITLS_RSA_WITH_AES_128_CCM_8",
     .stdName = "TLS_RSA_WITH_AES_128_CCM_8",
     ...
     .strengthBits = 128},
    {.enable = true,
     .name = "HITLS_RSA_WITH_AES_256_CCM",
     .stdName = "TLS_RSA_WITH_AES_256_CCM",
     ...
     .strengthBits = 256},
    {.enable = true,
     .name = "HITLS_RSA_WITH_AES_256_CCM_8",
     .stdName = "TLS_RSA_WITH_AES_256_CCM_8",
    ...
    {.enable = true,
     .name = "HITLS_ECDHE_SM4_CBC_SM3",
     .stdName = "TLS_ECDHE_SM4_CBC_SM3",
     ...
     .strengthBits = 128},
    {.enable = true,
     .name = "HITLS_ECC_SM4_CBC_SM3",
     .stdName = "TLS_ECC_SM4_CBC_SM3",
    ...
    HITLS_CipherAlgo cipherAlgo, HITLS_HashAlgo hashAlgo)
{
    ...
    for (uint32_t i = 0; i < (sizeof(g_cipherSuiteList) / sizeof(g_cipherSuiteList[0])); i++) {
        ...
        if (IS_DTLS_VERSION(version)) {
            if ((version < g_cipherSuiteList[i].maxDtlsVersion) || (version > g_cipherSuiteList[i].minDtlsVersion)) {
                continue;
            }
        } else {
            if ((version < g_cipherSuiteList[i].minVersion) || (version > g_cipherSuiteList[i].maxVersion)) {
                continue;
            }
        }
        if ((kxAlgo != HITLS_KEY_EXCH_NULL) && (g_cipherSuiteList[i].kxAlg != kxAlgo)) {
            continue;
        }
        if ((authAlgo != HITLS_AUTH_NULL) && (g_cipherSuiteList[i].authAlg != authAlgo)) {
            continue;
        }
        if ((cipherAlgo != HITLS_CIPHER_NULL) && (g_cipherSuiteList[i].cipherAlg != cipherAlgo)) {
            continue;
        }
        if ((hashAlgo != HITLS_HASH_NULL) && (g_cipherSuiteList[i].hashAlg != hashAlgo)) {
            continue;
        }
        return g_cipherSuiteList[i].cipherSuite;
    }
    return 0;
}
