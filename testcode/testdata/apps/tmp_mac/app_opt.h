...
#define HITLS_APP_PROV_ENUM \
    HITLS_APP_OPT_MAC_PROVIDER, \
    HITLS_APP_OPT_MAC_PROVIDER_PATH, \
    HITLS_APP_OPT_MAC_PROVIDER_ATTR \

#define HITLS_APP_PROV_OPTIONS \
    {"provider", HITLS_APP_OPT_MAC_PROVIDER, HITLS_APP_OPT_VALUETYPE_STRING, \
        "Specify the cryptographic service provider for the MAC operation"}, \
    {"provider-path", HITLS_APP_OPT_MAC_PROVIDER_PATH, HITLS_APP_OPT_VALUETYPE_STRING, \
        "Set the path to the cryptographic service provider for the MAC operation"}, \
    {"provider-attr", HITLS_APP_OPT_MAC_PROVIDER_ATTR, HITLS_APP_OPT_VALUETYPE_STRING, \
        "Set additional attributes for the cryptographic service provider"} \

#define HITLS_APP_PROV_CASES \
