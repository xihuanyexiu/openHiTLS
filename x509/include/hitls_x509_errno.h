...
typedef enum {
    ...
    HITLS_X509_ERR_VFY_KEY_ALGID,
    HITLS_X509_ERR_VFY_KEY_PSS_MDALG,
    HITLS_X509_ERR_VFY_KEY_PSS_MGFALG,
    HITLS_X509_ERR_VFY_KEY_PSS_SALTLEN,
    ...
    HITLS_X509_ERR_INVALID_SIGNALG,
    HITLS_X509_ERR_CRL_ISSUER_EMPTY,
    HITLS_X509_ERR_CRL_TIME_INVALID,
    HITLS_X509_ERR_CRL_LACK_SIGNATURE,
    ...
    HITLS_X509_ERR_SET_ATTR_TOOMUCH,
    HITLS_X509_ERR_SET_ATTR_UNKNOWN,
    HITLS_X509_ERR_SET_ATTR_REPEAT,
    HITLS_X509_ERR_DUP_ATTR,
    ...
    HITLS_X509_ERR_PARSE_GENERALNAME,
    HITLS_X509_ERR_PARSE_GENERALNAME_DIR,
    ...
    HITLS_X509_ERR_PARSE_ERROR_TYPE,

    HITLS_X509_ERR_CSR_INVALID_PARAM = 0x04050001,
    HITLS_X509_ERR_CSR_INVALID_VERSION,
    HITLS_X509_ERR_CSR_INVALID_PUBKEY,
    HITLS_X509_ERR_CSR_INVALID_SUBJECT_DN,
    HITLS_X509_ERR_CSR_INVALID_ATTR,

    HITLS_CMS_ERR_INVALID_DATA = 0x04060001,
    ...
    HITLS_PKCS12_ERR_INVALID_INTERATION,
    ...
    HITLS_PKCS12_ERR_ERR_REPEATED_SET_ENTITYCERT,
    HITLS_PKCS12_ERR_ERR_REPEATED_SET_KEY,
} HITLS_X509_ERRNO;
